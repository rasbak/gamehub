...
class ActionConfigPass implements ConfigPassInterface
{
    ...
    private function getDefaultActionsConfig($view)
    {
        $actions = $this->doNormalizeActionsConfig(array(
            'delete' => array('name' => 'delete', 'label' => 'supprimer', 'icon' => 'trash-o', 'css_class' => 'btn btn-default'),
            'edit' => array('name' => 'edit', 'label' => 'modifier', 'icon' => 'edit', 'css_class' => 'btn btn-primary'),
            'new' => array('name' => 'new', 'label' => 'ajouter', 'css_class' => 'btn btn-primary'),
            'search' => array('name' => 'search', 'label' => 'rechercher'),
            'show' => array('name' => 'show', 'label' => 'action.show'),
            'list' => array('name' => 'list', 'label' => 'retour à la liste', 'css_class' => 'btn btn-secondary'),
        ));
